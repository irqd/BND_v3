<section id="about_us">
   <div class="container-fluid container-lg p-5" data-aos="fade-up">
      <div class="mb-5 text-center" data-aos="zoom-out">
         <h1 class="fw-bolder mb-0">About Us</h1>
      </div>

      <div class="row gx-5 justify-content-center align-items-center">
         <div class="col-md-8 col-lg-6 order-2 order-lg-1" data-aos="zoom-out">

            <h3 class="mb-4 fw-bold" data-aos="fade-down">
               Discover our story and join the journey.
            </h3>
            
            <div class="d-flex align-items-start" data-aos="fade-up" data-aos-delay="100">
               <div class="bg-primary bg-gradient bg-opacity-75 d-inline-flex align-items-center justify-content-center p-2 flex-shrink-0 me-3 rounded-3">
                  <img src="{{ asset('images/icons/book.gif') }}" alt="book.gif">
               </div>

               <div>
                  <h1 class="fs-6 fw-bold">Expertise and Knowledge</h1>
                  <p class="text-justify">We have extensive expertise and knowledge in the field of information technology, which can give clients confidence in their ability to provide effective solutions.</p>
               </div> 
            </div>
            ...
            <div class="d-flex align-items-start" data-aos="fade-up" data-aos-delay="200">
               ...
               <div>
                  <h1 class="fs-6 fw-bold">System Solutions</h1>
                  <p class="text-justify">As a system solutions provider, B&D IT Consultancy focuses on helping clients meet their IT needs, which can include everything from software development to network infrastructure.</p>
               </div> 
            </div>
            ...
            <div class="d-flex align-items-start" data-aos="fade-up" data-aos-delay="300">
               ...
               <div>
                  <h1 class="fs-6 fw-bold">Established in 2017</h1>
      ...
      <div class="row gx-5 justify-content-center align-items-center mt-5">
         <div class="col-md-10 col-lg-6 text-center" data-aos="zoom-in">
            <img class="img-fluid" 
               src="{{ asset('images/connecting-teams.svg') }}" 
               alt="connecting team" loading="lazy">
         </div>
         <div class="col-md-8 col-lg-6" data-aos="zoom-out">
            <h2 class="pt-4 mb-4 fw-bold" data-aos="fade-down" data-aos-delay="100">
               Innovative IT Solutions for Your Business Needs
            </h2>
            <p class="mb-0 fw-normal mb-4 lh-lg text-justify" data-aos="fade-up" data-aos-delay="200">
